...
function Hero({ lang }) {
  return (
    <header id="top" className="kit-section kit-section--forest kit-hero">
      <div className="kit-container kit-hero__grid" style={{ fontWeight: "500" }}>
        <div>
          ...
          <Reveal as="h1" className="kit-h1" delay={60}>
            {L(lang, "Zbuduj własne AI i ", "Build your own AI and ")}
            <span className="kit-accent" data-comment-anchor="95c7107d98-span">{L(lang, "zyskaj miliony.", "save millions.")}</span>
          </Reveal>
          <Reveal as="p" className="kit-lead" delay={120} style={{ marginTop: "var(--space-5)" }} data-comment-anchor="1480fb5ea5-span">
            {L(lang,
            "Sparx tworzy tani test wartości Twojej oferty. Płacisz za to, co działa.",
            "Sparx builds a low-cost proof of value for your offer. You pay for what works.")}
          </Reveal>
